...
public class FXMLAnchorPaneCadastrosProdutosDialogController implements Initializable {
    ...
    @FXML
    private ComboBox comboBoxProdutosCategoria;
...
//        this.comboBoxProdutosCategoria.selectionModelProperty().get();
    ...
    public void carregarComboBoxCategoria() {
        ...
        comboBoxProdutosCategoria.setItems(observableListCategoria);
    }
    ...
    public void handleButtonConfirmar() {
        ...
        if (validarEntradaDeDados()) {
            ...
            produto.setCategoria((Categoria) comboBoxProdutosCategoria.getSelectionModel().getSelectedItem());
    ...
    private boolean validarEntradaDeDados() {
        ...
        if (comboBoxProdutosCategoria.getSelectionModel().getSelectedItem() == null) {
